...
static int lua_flip(lua_State *L)
{
    ...
    if (argc != 0)
        return luaL_error(L, "wrong number of arguments");
#endif
    std::cout << "The function " << stringify(lua_flip) << " is completly \ndeprecated and will never\nbe supportet again!" << std::endl;
    return 0;
}
...
static int lua_rect(lua_State *L)
{
    ...
    if (radius == 0)
        C2D_DrawRectSolid(x1, y1, 0.5, x2 - x1, y2 - y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF));
    else
...
static int lua_fillcircle(lua_State *L)
{
    ...
    if (cur_screen != 1 && cur_screen != 0)
        return luaL_error(L, "you need to call initBlend to use GPU rendering");
#endif
    C2D_DrawCircleSolid(x, y, 0.5, radius, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF));
    return 0;
}
...
#endif
    u32 color = luaL_checkinteger(L, 5);
    C2D_DrawLine(x1, y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), x2, y2, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), 1, 1);
    return 0;
}
...
#endif
    u32 color = luaL_checkinteger(L, 5);
    C2D_DrawLine(x1, y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), x1, y2, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), 1, 1);
    C2D_DrawLine(x2, y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), x2, y2, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), 1, 1);
    C2D_DrawLine(x1, y2, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), x2, y2, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), 1, 1);
    C2D_DrawLine(x1, y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), x2, y1, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF), 1, 1);
    return 0;
}
...
static int lua_loadimg(lua_State *L)
{
    ...
    C2D_Image ret = C2DH::LoadTextureMem8888(bitmap->pixels, bitmap->width, bitmap->height);
...
static int lua_drawimg_full(lua_State *L)
{
    ...
    // sf2d_draw_texture_part_rotate_scale(texture->tex, x, y, radius, st_x, st_y, width, height, scale_x, scale_y);
        ...
        std::cout << "Not Supported\n";
    // sf2d_draw_texture_part_rotate_scale_blend(texture->tex, x, y, radius, st_x, st_y, width, height, scale_x, scale_y, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF));
    return 0;
}
...
static int lua_partial(lua_State *L)
{
    ...
    if (argc == 8)
        std::cout << "Not Supported\n";
    // sf2d_draw_texture_part_blend(file->tex, x, y, st_x, st_y, width, height, RGBA8((color >> 16) & 0xFF, (color >> 8) & 0xFF, (color)&0xFF, (color >> 24) & 0xFF));
    else
        std::cout << "Not Supported\n";

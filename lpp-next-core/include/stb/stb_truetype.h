...
//   C++ 1.01 (2014-12-08) fix subpixel position when oversampling to exactly
//   match
...
extern int stbtt_BakeFontBitmap(
...
extern void stbtt_GetBakedQuad(
...
extern int stbtt_PackBegin(stbtt_pack_context *spc, unsigned char *pixels,
...
extern int stbtt_PackFontRange(stbtt_pack_context *spc, unsigned char *fontdata,
...
extern int stbtt_PackFontRanges(stbtt_pack_context *spc,
...
extern void stbtt_PackSetOversampling(stbtt_pack_context *spc,
...
extern void stbtt_GetPackedQuad(
...
unsigned char *stbtt_GetCodepointBitmapSubpixel(const stbtt_fontinfo *info,
                                                float scale_x, float scale_y,
                                                float shift_x, float shift_y,
                                                int codepoint, int *width,
                                                int *height, int *xoff,
...
int stbtt_PackBegin(stbtt_pack_context *spc, unsigned char *pixels, int pw,
...
int stbtt_PackFontRange(stbtt_pack_context *spc, unsigned char *fontdata,
                        int font_index, float font_size,
...
void stbtt_GetPackedQuad(stbtt_packedchar *chardata, int pw, int ph,
                         int char_index, float *xpos, float *ypos,
